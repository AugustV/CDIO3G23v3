...
public class Chancecarddeck {
    ...
    private Chancecarddeck(){
        ...
        deck[i++] = new Chancecard("Federal Grant","Your business recieved a federal grant",3); //2
        ...
        deck[i++] = new Chancecard("Bad Exposure","Some of the bonds on your account go to zero",-4);//9
        deck[i++] = new Chancecard("Big time investment","You gain an influx of capital from an investor ",3);//10
        deck[i++] = new Chancecard("Gold reserves","Your gold ses a large appreciation",6);//11
        deck[i++] = new Chancecard("Black Monday","The markets drop and you lost a vast amount of money",-5);//12
